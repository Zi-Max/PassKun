...
@app.command()
def add_record(key_path: Annotated[str, typer.Argument()], file_path: Annotated[str, typer.Argument()],
                record_name: Annotated[str, typer.Argument()], record: Annotated[str, typer.Argument()]):
    """
    Add a new record
...
@app.command()
def show_records(key_path: Annotated[str, typer.Argument()], file_path: Annotated[str, typer.Argument()]):
    """
